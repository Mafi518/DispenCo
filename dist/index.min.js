...
document.querySelectorAll('.tab-triggers__item').forEach(elem => {
    elem.addEventListener('click', e => {
        e.preventDefault()
        const id = e.target.getAttribute('href').replace('#', '')

        document.querySelectorAll('.tab-triggers__item').forEach( child => {
            child.classList.remove('tab-triggers__item-active')
        })

        document.querySelectorAll('.content__list').forEach( child => {
...
const send = document.querySelector('.contacts__button').addEventListener('click', (e) => {
    e.preventDefault()
    let successMessage = document.querySelector('.success__popup')
